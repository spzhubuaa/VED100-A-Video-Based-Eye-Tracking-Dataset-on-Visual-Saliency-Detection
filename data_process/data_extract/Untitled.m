...
video_file = 'D:\Exp\HEVCtupian\ClassA-2560x1600\SteamLocomotiveTrain_2560x1600_60_10bit_crop.yuv';
...
%     VV = double(VV);
    ...
    UU = UU/1023*255;
    VV = VV/1023*255;
%     Y = im2uint8(Y/1023*255);
%     Y = im2double(Y);
%     UU = im2uint8(UU/1023*255);
%     UU = im2double(UU);
%     VV = im2uint8(VV/1023*255);
%     VV = im2double(VV);
